...
export class PurchaseStateListAdminComponent implements OnInit {

    protected fileName = 'PurchaseState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PurchaseStateDto>();
    ...
    public async edit(dto: PurchaseStateDto) {
    ...
    public async view(dto: PurchaseStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PurchaseStateDto) {
    ...
    public async duplicate(dto: PurchaseStateDto) {
    ...
    public exportPdf(dto: PurchaseStateDto): void {
...
// add
	...
	public initDuplicate(res: PurchaseStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<PurchaseStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<PurchaseStateDto>) {
